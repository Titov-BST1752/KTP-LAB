...
class TriangleArea {
    ...
    public static void main(String[] args) {
        ...
        if (result != 0) {
            ...
            System.out.println("Площадь треугольника = " + df.format(result));
        }
    }

    private static double computeArea(Point3d point1, Point3d point2, Point3d point3) {
        if (point1.equals(point2) || point1.equals(point3) || point2.equals(point3)) {
            System.out.println("Координаты точек равны, треугольник не построить");
            return 0d;
        }
